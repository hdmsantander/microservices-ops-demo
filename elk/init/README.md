...
The container uses `network_mode: host` to reach Kafka (9092), Connect (8083), and Kibana (5601). It runs once and exits; Query and Inventory depend on it completing successfully before they start.
